...
# unutar form ide npr "input" koji je polutag sa "type = text" a Atom jos dodao "value" i "name" koje Brad brise
# potom input type "radio" pored kojeg se moze napisati gomila opcija npr "checked" a onda iza ide tekst kojeg ce prikacit uz radio button!
# "textarea" za slobodni unos!
